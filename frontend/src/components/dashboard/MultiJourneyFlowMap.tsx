    ...
    <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
      ...
      <div style={{ padding: '10px 16px 6px', borderBottom: '1px solid var(--gray100)', display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        <span style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <span style={{ display: 'flex', alignItems: 'center', gap: 3, fontSize: 'var(--fs-small)', color: '#185FA5' }}>
            <span style={{ width: 7, height: 7, borderRadius: '50%', background: '#185FA5', display: 'inline-block' }} />
            Agent
          </span>
          <span style={{ display: 'flex', alignItems: 'center', gap: 3, fontSize: 'var(--fs-small)', color: 'var(--teal)' }}>
      ...
      {lanes.map((lane, i) => {
        ...
        const dotColor = isAgent ? '#185FA5' : 'var(--teal)'
        const bgTint = isAgent ? 'rgba(24,95,165,0.03)' : 'rgba(13,148,136,0.03)'
