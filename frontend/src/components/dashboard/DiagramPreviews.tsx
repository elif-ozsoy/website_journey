...
export function ComparePreview() {
  return (
    <svg viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="21" y="13" textAnchor="middle" fontSize="5" fill="#0072B2" fontWeight="700">AI</text>
      <text x="59" y="13" textAnchor="middle" fontSize="5" fill="#E69F00" fontWeight="700">Human</text>
      ...
      <rect x="8" y="36" width="10" height="4" rx="1" fill="#0072B2" fillOpacity="0.5"/>
      ...
      <rect x="46" y="36" width="20" height="4" rx="1" fill="#E69F00" fillOpacity="0.5"/>
    </svg>
  )
}
...
export function PolicyBotPreview() {
  return (
    <svg viewBox="0 0 80 50" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="31" y="9" width="20" height="5" rx="1.5" fill="#E69F00" fillOpacity="0.25" stroke="#E69F00" strokeWidth="0.8"/>
      <text x="41" y="13" textAnchor="middle" fontSize="3.5" fill="#E69F00" fontWeight="700">policy</text>
      <line x1="41" y1="14" x2="36" y2="16" stroke="#E69F00" strokeWidth="0.8" strokeOpacity="0.6"/>
      ...
      {/* AI label */}
      <text x="6" y="45" fontSize="3.8" fill="#0072B2" fontWeight="700">AI</text>
      <text x="13" y="45" fontSize="3.8" fill="#475569">guided by</text>
      <text x="34" y="45" fontSize="3.8" fill="#E69F00" fontWeight="700">human policy</text>
    </svg>
  )
}
